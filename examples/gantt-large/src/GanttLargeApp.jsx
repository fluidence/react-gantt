...
function GanttLargeApp() {
	...
	useConstructor(() => {
		...
		if (typeof retrievedState !== "undefined" && retrievedState !== null) {
			...
			if (typeof retrievedState.showProcedureEquipment !== "undefined" && retrievedState.showProcedureEquipment !== null)
				initialState.showProcedureEquipment = retrievedState.showProcedureEquipment;
